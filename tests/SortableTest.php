...
class SortableTest extends TestCase
{
    ...
    public function it_can_swap_the_position_of_two_given_models()
    {
        ...
        $fiOrCo = $firstModel->order_column;
        $seOrCo = $secondModel->order_column;
    ...
    public function it_can_use_config_properties()
    {
        ...
        $this->assertEquals(config('eloquent-sortable.groups'), $model->getSortableGroups());
    }
    ...
    public function it_can_override_config_properties()
    {
        ...
        $this->assertEquals($model->getSortableGroups(), [
            'first_group',
            'second_group',
        ]);
    }
